	...
	<div class="col-md-7 align-self-center text-end">
		<div class="d-flex justify-content-end align-items-center">
			<ol class="breadcrumb justify-content-end">
				...
				<li class="breadcrumb-item active">New Sevices</li>
			</ol>
...
<div class="row">
	<div class="col-12">
	   <div class="card">
			<div class="card-body">
				<h4 class="card-title">New Sevices</h4>
				...
				@endif
					<div class="row">
						...
						<div class="col-md-6">
							...
							<input class="form-control" type="text" name="name" placeholder="Enter Name" value="{{ old('name') }}" required data-parsley-error-message="The name field is required.">
                            @if($errors->has('name')) <span class="text-danger"> <i class="fa fa-warning"></i> {{ $errors->first('name') }}</span> @endif
						</div>
						<div class="col-md-6">
						    <label class="form-label">Minimum Price</label>
							<input class="form-control" type="text" name="min_price" id="min_price" placeholder="Enter Minimum Price" value="{{ old('min_price') }}" required data-parsley-type="number">
                            @if($errors->has('min_price')) <span class="text-danger"> <i class="fa fa-warning"></i> {{ $errors->first('min_price') }}</span> @endif
						</div>
						<div class="col-md-6">
						    <label class="form-label">Maximum Price</label>
							<input class="form-control" type="text" name="max_price" id="max_price" placeholder="Enter Maximum Price" value="{{ old('max_price') }}" required data-parsley-type="number">
